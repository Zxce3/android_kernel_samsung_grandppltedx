...
#ifndef _MTK_MT6775_H_
#define _MTK_MT6775_H_
...
#define PLATFORM_SOC_CHIP 0x6775
/*tag end*/

/*device tree mode*/
/* A-Die interface pinmux base */
#define CONSYS_IF_PINMUX_REG_BASE	0x102D0000
#define CONSYS_IF_PINMUX_01_OFFSET	0x000003B0
#define CONSYS_IF_PINMUX_01_MASK	0x00000000
#define CONSYS_IF_PINMUX_01_VALUE	0x22222222
#define CONSYS_IF_PINMUX_02_OFFSET	0x000003C0
#define CONSYS_IF_PINMUX_02_MASK	0xFFFFFFF0
#define CONSYS_IF_PINMUX_02_VALUE	0x00000002
...
#define CONSYS_TOP1_PWR_CTRL_OFFSET	0x00000324
#define CONSYS_PWR_CONN_ACK_OFFSET	0x00000190
#define CONSYS_PWR_CONN_ACK_S_OFFSET	0x00000194
...
/*AXI bus*/
#define CONSYS_TOPAXI_PROT_EN_OFFSET	0x220
...
#define CONSYS_PROT_MASK		((0x1<<10) | (0x1<<19))	/* bit 10, 19 */
...
#define CONSYS_PWR_ON_ACK_BIT		(0x1 << 10)

/*CONSYS_PWR_CONN_ACK_S_REG*/
#define CONSYS_PWR_ON_ACK_S_BIT		(0x1 << 10)

/*CONSYS_PWR_CONN_TOP2_ACK_REG*/
#define CONSYS_TOP2_PWR_ON_ACK_BIT	(0x1 << 28)

/*CONSYS_PWR_CONN_TOP2_ACK_S_REG*/
#define CONSYS_TOP2_PWR_ON_ACK_S_BIT	(0x1 << 29)
